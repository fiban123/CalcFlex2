...
void InfoBar::info_button_callback() { std::cout << "info button pressed\n"; }
...
InfoBar::InfoBar(sf::RenderWindow* _window, sf::Vector2u* _window_size, sf::Font* _font)
    ...
    text_area_style = TextAreaStyle{.text_color = INFO_BAR_TEXT_COLOR,
    ...
    info_button_style = ButtonStyle{.bg_color = BUTTON_BG_COLOR,
