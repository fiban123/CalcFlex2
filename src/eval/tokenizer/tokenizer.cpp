...
/* emplaces a new token new_token into a string token such that new_token is in between 
the left and right strings. decrements i depending on how many new tokens are inserted */
